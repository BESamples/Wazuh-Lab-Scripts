...
- Installs Wazuh Agent automatically from Downloads folder
...
```powershell
Run this command to download the script but the Wazuh agent will need to downloaded from the Wazuh Website. Copy everything below:
